...
const styles= {
    wrapper: `h-[50rem] w-[70rem] flex flex-col justify-start items-center gap-[1rem] p-[1rem] overflow-scroll font-mediumSerif`,
...
const PostModal = () => {
    ...
    return(
        <div className={styles.wrapper}>
            ...
            <div className={styles.smallField}>
                <span className={styles.fieldTitle}>BannerImageURL</span>
                <span className={styles.inputContainer}>
                    <input
                        className={styles.inputField}
                        type='text'
