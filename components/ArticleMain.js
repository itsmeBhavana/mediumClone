...
const styles={
  ...
  postHeaderContainer: `flex items-between justify-center mt-[2.2rem] mb-[1.2rem] justify-between`,
  authorContainer: `flex gap-[1rem]`,
  authorProfileImageContainer:`h-[3rem] w-[3rem] rounded-full grid center overflow-hidden`,
  ...
  return(
    <div className={styles.wrapper}>
      <div className={styles.content}>
        ...
        <div className={styles.artilceMainContainer}>
          ...
          <h4 className={styles.subtitle}>
            <div>{post?.data?.author}, Jun 15, 2022</div>
